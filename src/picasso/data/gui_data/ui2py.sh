...
sed -i "/class Ui_MainWindow/ipng_of_alpha = pkg_resources.resource_filename('picasso.data', 'gui_data/of_alpha.png')" picasso_design.py
sed -i "/class Ui_MainWindow/ipng_of_alphaxTx = pkg_resources.resource_filename('picasso.data', 'gui_data/of_alphaxTx.png')" picasso_design.py
sed -i "/class Ui_MainWindow/ipng_of_condN = pkg_resources.resource_filename('picasso.data', 'gui_data/of_condN.png')" picasso_design.py
sed -i "/class Ui_MainWindow/ipng_of_ePe = pkg_resources.resource_filename('picasso.data', 'gui_data/of_ePe.png')" picasso_design.py
sed -i "/class Ui_MainWindow/ipng_of_ePealphaxTx = pkg_resources.resource_filename('picasso.data', 'gui_data/of_ePealphaxTx.png')" picasso_design.py
sed -i "/class Ui_MainWindow/ipng_of_sigmaxTsigmax = pkg_resources.resource_filename('picasso.data', 'gui_data/of_sigmaxTsigmax.png')" picasso_design.py
sed -i "/class Ui_MainWindow/ipng_of_xTx = pkg_resources.resource_filename('picasso.data', 'gui_data/of_xTx.png')" picasso_design.py
